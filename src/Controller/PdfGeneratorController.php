...
public function index($id, CampingRepository $campingRepository, ParticipationsRepository $participationRepository, MaillingController $mailingController): Response
    {
