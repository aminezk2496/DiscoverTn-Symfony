...
class EvenementClientController extends AbstractController
{
    ...
    public function index(EvenementRepository $evenementRepository,SessionInterface $session, PaginatorInterface $paginator, Request $request): Response
    ...
    public function new(Request $request,SessionInterface $session, EvenementRepository $evenementRepository): Response
    {$utilisateurController = new UtilisateurController();
        $user=$utilisateurController->getDataUserConnected($session);
    ...
    public function edit(Request $request,SessionInterface $session, Evenement $evenement, EvenementRepository $evenementRepository): Response
    {$utilisateurController = new UtilisateurController();
        $user=$utilisateurController->getDataUserConnected($session);
        $form = $this->createForm(Evenement1Type::class, $evenement);
        $form->handleRequest($request);
