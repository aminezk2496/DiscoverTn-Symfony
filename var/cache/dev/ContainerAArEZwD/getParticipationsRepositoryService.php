 ...
 */
class getParticipationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipationsRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipationsRepository.php';

        return $container->privates['App\\Repository\\ParticipationsRepository'] = new \App\Repository\ParticipationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
