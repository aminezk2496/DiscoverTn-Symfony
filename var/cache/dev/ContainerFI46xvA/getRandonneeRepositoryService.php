 ...
 */
class getRandonneeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RandonneeRepository' shared autowired service.
     *
     * @return \App\Repository\RandonneeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RandonneeRepository.php';

        return $container->privates['App\\Repository\\RandonneeRepository'] = new \App\Repository\RandonneeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
